...
import { Printer, X, ExternalLink, CheckCircle2 } from 'lucide-react';
...
export const BatchPrintModal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl p-4 mb-4 shadow-xl border border-slate-200 flex flex-wrap items-center justify-between gap-4 print:hidden sticky top-2 z-10 print-hide">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            {printModalConfig.mode === 'DELIVERY_LIST'
              ...
              : 'Bố cục 6 đơn/trang A4 kèm đường nét đứt và ký hiệu kéo cắt ✂️ dán bao bì.'}
          </p>
        </div>
                    ...
                    {pageOrders.map((order, cellIdx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <A4OrderInvoice order={order} settings={settings} />
                        </div>
                      );
                    })}
